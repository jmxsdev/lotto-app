...
class ElGuacharitoResultsTest extends TestCase
{
    ...
    public function test_seeder_registra_juego_con_scraper_class(): void
    {
        ...
        $this->assertEquals('https://loteriadehoy.com/animalito/elguacharitomillonario/resultados/', $juego->scraper_url);
    ...
    public function test_seed_y_scrape_persisten_resultados(): void
    {
        ...
        $this->assertEquals(95, $persistido->numeros_ganadores['numero']);
        $this->assertEquals('Escarabajo', $persistido->numeros_ganadores['nombre_animal']);
    ...
    public function test_dedupe_al_rescrapear_el_mismo_dia(): void
    {
        ...
        $scraper->saveResults($resultados, '2026-09-01');
        $this->assertEquals(4, Resultado::count(), 'No debe duplicarse el resultado del mismo sorteo');
    }
