...
class LimitesScopedApiTest extends TestCase
{
    ...
    public function test_limites_entidad_banca_retorna_todos_los_juegos()
    {
        ...
        $this->assertCount(19, $data['juegos']);
        $this->assertCount(38, $data['limites']);
        $this->assertCount(38, $data['origen']);
    ...
    public function test_scope_bancas_master_ve_solo_sus_bancas()
    {
        ...
        $this->assertCount(19, $data['juegos']);
        $this->assertCount(76, $data['limites']); // 2 entidades × 19 juegos × 2 monedas
    ...
    public function test_scope_grupos_banca_solo_sus_grupos()
    {
        ...
        $this->assertCount(38, $data['mixto']);
