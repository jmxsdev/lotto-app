...
class LimitesScopedApiTest extends TestCase
{
    ...
    public function test_limites_entidad_banca_retorna_todos_los_juegos()
    {
        ...
        // 13 juegos sembrados × 2 monedas, en una sola llamada
        $this->assertCount(13, $data['juegos']);
        $this->assertCount(26, $data['limites']);
        $this->assertCount(26, $data['origen']);
    ...
    public function test_limites_juegos_inactivos_excluidos()
    {
        ...
        // Solo los 13 juegos activos sembrados, sin el inactivo
        $this->assertCount(13, $data['juegos']);
        $this->assertCount(26, $data['limites']);
    ...
    public function test_scope_bancas_master_ve_solo_sus_bancas()
    {
        ...
        $this->assertCount(13, $data['juegos']);
        $this->assertCount(52, $data['limites']); // 2 entidades × 13 juegos × 2 monedas
    ...
    public function test_scope_grupos_banca_solo_sus_grupos()
    {
        ...
        $this->assertCount(26, $data['mixto']);
