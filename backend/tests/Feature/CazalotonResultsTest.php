...
use Database\Seeders\CazalotonSeeder;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class CazalotonResultsTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->seed(CazalotonSeeder::class);
    }
    ...
    public function test_seeder_registra_juego_con_scraper_class(): void
    {
        ...
        $this->assertEquals('Cazaloton', $juego->name);
        $this->assertEquals('animalitos', $juego->type);
        $this->assertTrue($juego->requires_scraper);
        $this->assertEquals('https://loteriadehoy.com/animalito/cazaloton/resultados/', $juego->scraper_url);
    ...
    public function test_seed_y_scrape_persisten_resultados(): void
    {
        ...
        $this->assertEquals(5, $persistido->numeros_ganadores['numero']);
        $this->assertEquals('Leon', $persistido->numeros_ganadores['nombre_animal']);
