...
| 18 | `selva-plus` | ✅ | ✅ | ✅ | ✅ | ❌ | API oficial: 13 sorteos, 101 figuras + 2 comodines ✓; premiación base 80×/comodines 160×/200× documentada de fuente oficial; **comodín OBSERVADO (letra `A`/`B` en `result`; caso real 15-sep 09:15) y capturado estructurado** (`comodin`+`comodin_nombre`, H8 resuelto). **Reglamento NO publicado (WU f26)**: bundle de selvaplus.com (`index-BI-rgou6.js`) sin reglamento; footer con logo "Lotería de Oriente" |
