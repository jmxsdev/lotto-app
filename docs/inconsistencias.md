...
| H1 | Motor/datos | Comodín MEGA 40× sin representación en los datos de la fuente | Sin soporte hasta fuente fiable (política: no simular). **WU f26**: el sitio oficial megaanimal40.com confirma en su texto de premios **30× por animal y 40× con el comodín MEGA** ("si el resultado sale con la palabra MEGA tu premio se aumenta (40) veces lo apostado") → la premiación queda respaldada por fuente oficial; la representación en `result` sigue sin observarse y el modelado del comodín sigue pendiente del ciclo del motor |
